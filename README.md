...
<br>1)Partition, set root/home size manually, currently EXT4 or btrfs 2) Installing bare minimum build with pacstrap 3) Ask for user/host informations and set user/root pw set systemctl service on for network manager on etc.
<br>
