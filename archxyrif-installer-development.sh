...
echo "============================================================================================================================="
echo "============================================================================================================================="
echo "                                                                                     "echo "Table of Contents:               "
echo "       d8888                 888      Y88b   d88P                  d8b  .d888        "echo "1)Disk Selection & Format        "
echo "      d88888                 888       Y88b d88P                   Y8P d88P          "echo "2)Pacstrap:Installing Base system"
echo "     d88P888                 888        Y88o88P                        888           "echo "3)Generating fstab               "
echo "    d88P 888 888d888 .d8888b 88888b.     Y888P    888  888 888d888 888 888888        "echo "4)Setting Basic variables        "
echo "   d88P  888 888P"  d88P"    888 "88b    d888b    888  888 888P"   888 888           "echo "5)Installing GRUB for UEFI       "
echo "  d88P   888 888    888      888  888   d88888b   888  888 888     888 888           "echo "6)Setting configs/enabling.srv   "
echo " d8888888888 888    Y88b.    888  888  d88P Y88b  Y88b 888 888     888 888           "echo "7)Setting Pacman Mirror          "
echo "d88P     888 888     "Y8888P 888  888 d88P   Y88b  "Y88888 888     888 888           "echo "Optional:                        "
echo "                                                       888                           "echo "8A)GPU-Guided install            "                
echo "                                                  Y8b d88P                           "echo "8B)Guided Window Manager Install "                    
echo "                                                    Y88P                             "echo "8C)Guided Login Manager Install  "   
echo "        Automated and Interactive - Arch Linux Installer                             "echo "9)Extra Pacman & AUR PKG Install "
echo "                                                                                     "echo "If Hyprland Selected As WM       "
echo "        GNU GENERAL PUBLIC LICENSE Version 3License - Copyright (c) Terra88          "echo "10)Optional Theme install        "
echo "============================================================================================================================="
echo "============================================================================================================================="
echo
