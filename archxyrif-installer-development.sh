...
logo(){
echo "${GREEN}#===================================================================================================#${RESET}"
echo "${GREEN}| The Great Monolith of Installing Arch Linux!                                                      |${RESET}"
echo "${GREEN}#===================================================================================================#${RESET}"
echo "${GREEN}|                                                                                                   |${RESET}"
echo "${GREEN}|        d8888                 888      Y88b   d88P                  d8b  .d888                     |${RESET}"
echo "${GREEN}|       d88888                 888       Y88b d88P                   Y8P d88P                       |${RESET}"
echo "${GREEN}|      d88P888                 888        Y88o88P                        888                        |${RESET}"
echo "${GREEN}|     d88P 888 888d888 .d8888b 88888b.     Y888P    888  888 888d888 888 888888                     |${RESET}"
echo "${GREEN}|    d88P  888 888P.  d88P.    888 .88b    d888b    888  888 888P.   888 888                        |${RESET}"
echo "${GREEN}|   d88P   888 888    888      888  888   d88888b   888  888 888     888 888                        |${RESET}"
echo "${GREEN}|  d8888888888 888    Y88b.    888  888  d88P Y88b  Y88b 888 888     888 888                        |${RESET}"
echo "${GREEN}| d88P     888 888     .Y8888P 888  888 d88P   Y88b  .Y88888 888     888 888                        |${RESET}"
echo "${GREEN}|                                                        888                                        |${RESET}"
echo "${GREEN}                                                   Y8b d88P                                         |${RESET}"
echo "${GREEN}|                                                     Y88P                                          |${RESET}"
echo "${GREEN}|         Semi-Automated / Interactive - Arch Linux Installer                                       |${RESET}"
echo "${GREEN}|                                                                                                   |${RESET}"
echo "${GREEN}|        GNU GENERAL PUBLIC LICENSE Version 3 - Copyright (c) Terra88(Tero.H)                       |${RESET}"
echo "${GREEN}#===================================================================================================#${RESET}"
echo "${GREEN}|-Table of Contents:                |-0) Disk Format INFO                                           |${RESET}"
echo "${GREEN}#===================================================================================================#${RESET}"
echo "${GREEN}|-1)Disk Selection & Format         |- UEFI & BIOS(LEGACY) SUPPORT                                  |${RESET}"
echo "${GREEN}|-2)Pacstrap:Installing Base system |- wipes old signatures                                         |${RESET}"
echo "${GREEN}|-3)Generating fstab                |- Partitions: BOOT/EFI(1024MiB)(/ROOT)(/HOME)(SWAP)            |${RESET}"
echo "${GREEN}|-4)Setting Basic variables         |- 1) Quick Partition: Root/Home & Swap on or off options       |${RESET}"
echo "${GREEN}|-5)Installing GRUB for UEFI        |- Filesystems: FAT32 on Boot/EFI, EXT4 or BTRFS                |${RESET}" 
echo "${GREEN}|-6)Setting configs/enabling.srv    |- Filesystems: FAT32 on Boot/EFI, EXT4 or BTRFS                |${RESET}"
echo "${GREEN}|-7)Setting Pacman Mirror           |- 2) Custom Partition/Format Route for ext4,btrfs,xfs,f2fs     |${RESET}"
echo "${GREEN}|-Optional:                         |- 3) LV & LUKS Coming soon.                                    |${RESET}"
echo "${GREEN}|-8A)GPU-Guided install             |---------------------------------------------------------------|${RESET}"
echo "${GREEN}|-8B)Guided Window Manager Install  |# Author  : Terra88(Tero.H)                                    |${RESET}"
echo "${GREEN}|-8C)Guided Login Manager Install   |# Purpose : Arch Linux custom installer                        |${RESET}"
echo "${GREEN}|-9)Extra Pacman & AUR PKG Install  |# GitHub  : http://github.com/Terra88                          |${RESET}"
echo "${GREEN}|-If Hyprland Selected As WM        | ↜(╰ •ω•)╯ψ ↑_(ΦωΦ;)Ψ ୧( ಠ┏ل͜┓ಠ )୨ (ʘдʘ╬) ( •̀ᴗ•́ )و   (◣◢)ψ     |${RESET}"
echo "${GREEN}|-10)Optional Theme install         | (づ｡◕‿‿◕｡)づ ◥(ฅº￦ºฅ)◤ (㇏(•̀ᵥᵥ•́)ノ) ＼(◑д◐)＞∠(◑д◐)          |${RESET}"
echo "${GREEN}#===================================================================================================#${RESET}"
}
#=========================================================================================================================================#
#!/usr/bin/env bash
